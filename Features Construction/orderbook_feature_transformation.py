...
filename2 = new_features_resultpath + 'all_features_new_intc_fillna_time.csv'
#filename2 = new_features_resultpath + 'all_features_new_aapl_fillna_time.csv'
#ilename2 = new_features_resultpath + 'all_features_new_msft_fillna_time.csv'
#filename2 = new_features_resultpath + 'all_features_new_amzn_fillna_time.csv'
#filename2 = new_features_resultpath + 'all_features_new_goog_fillna_time.csv'
